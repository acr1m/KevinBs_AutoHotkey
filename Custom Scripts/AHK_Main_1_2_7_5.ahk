...
#Include E:\Assets\Scripts\AutoHotkey\Custom Scripts\AHK_GUI_Mouse_Control.ahk
;===============================================================================
...
#IfWinActive ahk_class XLMAIN ahk_exe EXCEL.EXE
{
	...
	^e::
	{
		gosub setExcelBorderColorToAccent1
		SetKeyDelay, 50
		Send, {Home}
		Send, {Shift down}
		Send, {Right 8}
