/*! USER COPY - TillaGoto
....this file...................................................................
.......E:\Library\OneDrive\Documents\AutoHotkey\SciTE\user-TillaGoto.ahk
....original file...............................................................
...
TrayClose: ;{ 
/* acr1m 2022-01-26_02-03-06_PM
 *	- Added breaker-switch [Ctrl+F12] to make it easier to 
 *	  restart the app if it misbehaves.
 */
^F12::
ExitApp  ;}

/* acr1m 2022-01-26_02-05-49_PM 
 * - added [Ctrl+Shift+F12] to restart the app if it misbehaves
 */
^+F12::
	Reload ;; Replaces the currently running instance of the script with a new one.
	Sleep, 1000 ;; just 1 second timer to keep this script from doing anything else while it's replaced.
	return ;; again, just a fail-safe return statement to conclude the current hotkey thread.
...
;}
		...
		;; [:blank:] => \h => any horizontal white space character
		i := RegExMatch(s, "m)(*ANYCRLF)^[[:blank:]]*\K[a-zA-Z0-9#_@\$\?\[\]]+"
						 . "(?=\(.*?\)(\s+\Q" u "\E.*?[\r\n]+)*?\s+\{)", t, i)
