...
VL_Create()
{
	...
	Gui 4:Add, ListView, x0 y0 w%VL_width% h%VL_height% gVL_Inspect vVL_Listview, Scope|Variable name|Contents (partial)
	VL_Update()
	;~ Gui 4:Show, w320 h240, Variable list
	Gui 4:Show, w%VL_width% h%VL_height%, Variable list
}
